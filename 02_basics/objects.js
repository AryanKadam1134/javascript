...
console.log(Object.entries(user)); // Output: [["full name", "Aryan Rajaram Kadam"], ["name", "Aryan Kadam"], ["age", 21], ["email", "
console.log(Object.keys(user)); // Output: ["name", "age", "email", "isLoggedIn", "lastLoggedIn", "grettings"] (getting keys of the object) as an array
console.log(Object.values(user)); // Output: ["Aryan Kadam", 21, "